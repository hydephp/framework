...
#### [v0.37.2-beta](https://github.com/hydephp/framework/compare/v0.37.1-beta...v0.37.2-beta)

> 17 June 2022

- v0.37.2-beta - 2022-06-17 [`#544`](https://github.com/hydephp/framework/pull/544)
- Create update-changelog.yml [`#543`](https://github.com/hydephp/framework/pull/543)
- Update CHANGELOG.md [`f6084cb`](https://github.com/hydephp/framework/commit/f6084cb44354bf215afc79996954fd9d690bdb93)
- Update CHANGELOG.md [`ef14a72`](https://github.com/hydephp/framework/commit/ef14a72a7c4c809e714ac007ad372ba194e15eee)

#### [v0.37.1-beta](https://github.com/hydephp/framework/compare/v0.37.0-beta...v0.37.1-beta)

> 16 June 2022

- Merge pull request #48 from hydephp/Skip-test-if-the-_docs-directory-is-empty [`#542`](https://github.com/hydephp/framework/pull/542)
- Skip documentation index validation test if the _docs directory is empty [`#48`](https://github.com/hydephp/framework/pull/48)

#### [v0.37.0-beta](https://github.com/hydephp/framework/compare/v0.36.0-beta...v0.37.0-beta)

> 16 June 2022

- Merge pull request #45 from hydephp/recreate-validators [`#541`](https://github.com/hydephp/framework/pull/541)
- v0.37.0-beta - Create custom validator test framework [`#45`](https://github.com/hydephp/framework/pull/45)

#### [v0.36.0-beta](https://github.com/hydephp/framework/compare/v0.35.0-beta...v0.36.0-beta)

> 15 June 2022

- v0.36.x - Add package auto-discovery [`#540`](https://github.com/hydephp/framework/pull/540)
- v0.36.x - Add package auto-discovery [`#35`](https://github.com/hydephp/framework/pull/35)
- Sync commit timelines [`#539`](https://github.com/hydephp/framework/pull/539)
- Merge from framework upstream [`#31`](https://github.com/hydephp/framework/pull/31)
- Merge changes from monorepo [`#534`](https://github.com/hydephp/framework/pull/534)
- Delete .github (handled in monorepo) [`770f102`](https://github.com/hydephp/framework/commit/770f1026d5ad1c23828284e92cae480c7690451f)
- Create CHANGELOG.md [`549c1cc`](https://github.com/hydephp/framework/commit/549c1cc13f9197d26d2b4994a21c5b0f5baff112)
- Commit from GitHub Actions (Split monorepo) [`7443f73`](https://github.com/hydephp/framework/commit/7443f73106c9eecee48a397335f655bfb6a13119)

#### [v0.35.0-beta](https://github.com/hydephp/framework/compare/v0.34.2-beta...v0.35.0-beta)

> 14 June 2022

- v0.35.0-beta - Breaking internal restructuring [`#536`](https://github.com/hydephp/framework/pull/536)
- Update Changelog [`#535`](https://github.com/hydephp/framework/pull/535)
- Merge changes from monorepo [`#534`](https://github.com/hydephp/framework/pull/534)
- Merge changes from caendesilva/hyde-monorepo [`#529`](https://github.com/hydephp/framework/pull/529)
- Initial Subrepo Commit [`bb3c0c7`](https://github.com/hydephp/framework/commit/bb3c0c74684c9ec4b27a631c281d0a3ca3615eb3)
- Merge with monorepo [`478654d`](https://github.com/hydephp/framework/commit/478654df1836bce847a59f3f071bb4a7a1b8d578)
- Delete composer.lock [`2a3ab68`](https://github.com/hydephp/framework/commit/2a3ab6847c152bc1b6dba8112e1a4159f016c51b)

#### [v0.34.2-beta](https://github.com/hydephp/framework/compare/v0.34.1-beta...v0.34.2-beta)

> 10 June 2022

- Bump guzzlehttp/guzzle from 7.4.3 to 7.4.4 [`#530`](https://github.com/hydephp/framework/pull/530)
- Update Changelog [`#528`](https://github.com/hydephp/framework/pull/528)
- Automatic Changelog Update [`410ae71`](https://github.com/hydephp/framework/commit/410ae7199edf7590aba938950bb2f5d8771dbd37)

#### [v0.34.1-beta](https://github.com/hydephp/framework/compare/v0.34.0...v0.34.1-beta)

> 6 June 2022

- Add helper proxies to the Hyde facade [`#527`](https://github.com/hydephp/framework/pull/527)
- Apply fixes from StyleCI [`#526`](https://github.com/hydephp/framework/pull/526)
- Update Changelog [`#525`](https://github.com/hydephp/framework/pull/525)
- Create HydeHelperFacade [`e3d02d5`](https://github.com/hydephp/framework/commit/e3d02d567f4ce70a2c7aae5f0cb2da2feff02d19)
- Automatic Changelog Update [`1031ad7`](https://github.com/hydephp/framework/commit/1031ad7909f30642608e9bb43a36fdb4858f59a4)
- Add test for Hyde::hasFeature() [`2e4f0bf`](https://github.com/hydephp/framework/commit/2e4f0bfde5591364dd5a9045c3077618dbe3b5c0)
